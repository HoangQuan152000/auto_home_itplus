...
/* Private defines -----------------------------------------------------------*/
#define MOVE_SS_Pin GPIO_PIN_15
#define MOVE_SS_GPIO_Port GPIOC
...
#define BUTTON_FAN_Pin GPIO_PIN_5
#define BUTTON_FAN_GPIO_Port GPIOA
#define BUTTON_FAN_EXTI_IRQn EXTI9_5_IRQn
#define IN2_Pin GPIO_PIN_7
#define IN2_GPIO_Port GPIOA
#define INFRARED_1_Pin GPIO_PIN_0
